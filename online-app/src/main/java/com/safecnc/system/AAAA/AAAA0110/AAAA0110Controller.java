package com.safecnc.system.AAAA.AAAA0110;
...
import com.safecnc.system.AAAA.AAAA0110.service.AAAA0110Service;
...
@Slf4j
@Controller
public class AAAA0110Controller implements AbstractController, OpenApiTagType.SystemManagement {

    @Resource(name="AAAA0110Service")
    private AAAA0110Service service;

    /**
     * 다국어 코드 데이터 조회
     */
    @Transactional
    @Operation(summary = "다국어 코드 조회")
    @PostMapping(value="/AAAA0110/SEL00.nx")
     ...
     */
    @Transactional
    @Operation(summary = "다국어 코드 저장")
    @PostMapping(value="/AAAA0110/SAV00.nx")
